...
def is_walkable(self, x, y):
    cell = self.gm.grid[y][x]
    # Now includes checkpoints ($) as walkable paths [cite: 4, 12]
    return cell in [config.CHAR_EMPTY, config.CHAR_PATH, config.CHAR_CHARGER, config.CHAR_PICKUP]